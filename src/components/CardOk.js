...
export default function CardOk(index) {
  ...
  return (
    ...
    ">
      <a key={index} href="#" className="post-link border-2 border-transparent focus:outline focus:outline-4 focus:outline-offset-15	focus:outline-black dark:focus:outline-white hover:border-lt-purple dark:hover:border-dk-blue-light">
        <StaticImage
          src="../images/cat.jpg"
          alt=""
          width={500}
        ...
        <div className="self-center text-center">
          <span id={`title${index}`} className="post-title block text-lg font-bold md:text-2xl py-4 px-2
