  ...
  return (
    <footer>
      <div className="link-wrapper mx-auto my-0">
        <span style={spanStyle}><a className="border-solid border-transparent border-b-2 border-t-2 block py-1.5 text-lg" href="https://sanna.ninja">Sanna Kramsi</a></span>
